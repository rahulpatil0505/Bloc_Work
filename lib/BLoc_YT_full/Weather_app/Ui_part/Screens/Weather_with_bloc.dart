...
import '../widgets/aditional_info.dart';
import '../widgets/forcast_item.dart';
import '../../key.dart';

class WeatherScreenBLoc extends StatefulWidget {
  const WeatherScreenBLoc({super.key});

  @override
  State<WeatherScreenBLoc> createState() => _WeatherScreenBLocState();
}

class _WeatherScreenBLocState extends State<WeatherScreenBLoc> {
  @override
  void initState() {
    super.initState();
    context.read<WeatherBloc>().add(WeatherFeathed());
  }
